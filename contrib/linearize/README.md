# Linearize
Construct a linear, no-fork, best version of the Alterdot blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install alterdot_hash

https://github.com/dashpay/alterdot_hash
...
JSON-RPC server. Running `alterdotd` or `alterdot-qt -server` will be sufficient.
...
* `input`: alterdotd blocks/ directory containing blkNNNNN.dat
