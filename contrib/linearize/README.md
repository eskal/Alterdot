# Linearize
Construct a linear, no-fork, best version of the Bitcreds blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install bitcreds_hash

https://github.com/dashpay/bitcreds_hash
...
JSON-RPC server. Running `bitcredsd` or `bitcreds-qt -server` will be sufficient.
