...
-----------------------
Building the dependencies and Bitcreds requires some essential build tools and libraries to be installed before.
...
Add `CC=egcc CXX=eg++ CPP=ecpp` to the dependencies build and the Bitcreds build:
```bash
$ cd depends
