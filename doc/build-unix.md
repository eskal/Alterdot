...
-----------------------
Building the dependencies and Alterdot requires some essential build tools and libraries to be installed before.
...
Add `CC=egcc CXX=eg++ CPP=ecpp` to the dependencies build and the Alterdot build:
```bash
$ cd depends
