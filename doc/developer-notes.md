...
Alterdot is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Alterdot, where everyone uses
...
pay attention to for reviewers of Alterdot code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Alterdot uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Alterdot so that they can be integrated
