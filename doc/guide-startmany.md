...
### Send 1000 ADOT to New Addresses

Send exactly 1000 ADOT to each new address created above.
...
Copy the masternode private key and corresponding collateral output transaction that holds the 1000 ADOT.

*Note: The masternode private key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 1000 ADOT on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the alterdot github repo](https://github.com/dashpay/dash/blob/master/doc/masternode_conf.md)
...
## Update alterdot.conf on server

If you generated a new masternode private key, you will need to update the remote `alterdot.conf` files.
...
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `alterdot.conf` file.
...
and comparing with the official explorer at https://explorer.alterdot.org/chain/Alterdot
...
Search your Masternodes on https://alterdotninja.pl/masternodes.html
