...
This mechanism has been integrated into Bitcore-Node-Alterdot which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dashpay/insight-api-alterdot#web-socket-api](https://github.com/dashpay/insight-api-alterdot#web-socket-api)
* API: [https://github.com/dashpay/insight-api-alterdot#instantsend-transactions](https://github.com/dashpay/insight-api-alterdot#instantsend-transactions)
