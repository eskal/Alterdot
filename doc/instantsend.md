...
This mechanism has been integrated into Bitcore-Node-Bitcreds which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dashpay/insight-api-bitcreds#web-socket-api](https://github.com/dashpay/insight-api-bitcreds#web-socket-api)
* API: [https://github.com/dashpay/insight-api-bitcreds#instantsend-transactions](https://github.com/dashpay/insight-api-bitcreds#instantsend-transactions)
