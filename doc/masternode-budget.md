...
Bitcreds now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
Format: ```mngovernance prepare proposal-name url payment-count block-start bitcreds-address monthly-payment-bitcreds```
...
Format: ```mngovernance submit proposal-name url payment-count block-start bitcreds-address monthly-payment-bitcreds fee-tx```
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` BCRS to ```y6R9oN12KnB9zydzTLc3LikD9cCjjQzYG7```.
