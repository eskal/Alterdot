...
This document provides guidelines for internationalization of the Alterdot software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `alterdot_en.ts` remains unchanged.
