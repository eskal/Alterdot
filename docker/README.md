...
official/supported Docker Images found at https://hub.docker.com/r/dashpay/bitcredsd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/dashpay/bitcredsd-develop/ when changing the above text**