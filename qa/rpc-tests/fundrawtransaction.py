...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bitcreds address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid bitcreds address" in e.error['message'])
