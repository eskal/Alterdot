...
std::string CMasternode::StateToString(int nStateIn)
{
    switch(nStateIn) {
        ...
        case MASTERNODE_SENTINEL_CALL_EXPIRED:  return "SENTINEL_PING_EXPIRED";
...
bool CMasternodeBroadcast::CheckOutpoint(int& nDos)
{
    ...
    if (err == COLLATERAL_INVALID_AMOUNT) {
        LogPrint("masternode", "CMasternodeBroadcast::CheckOutpoint -- Masternode UTXO should have 1000 ADOT, masternode=%s\n", outpoint.ToStringShort());
        nDos = 33;
        return false;
    }
