    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  alterdot-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Alterdot in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 ADOT, 0.01 ADOT, 0.1 ADOT, 1 ADOT and 10 ADOT -- sort of like the paper money you use every day.</li> \
