...
enum
{
    ...
    bitcredsconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY           = (1U << 4), // enforce NULLDUMMY (BIP147)
    ...
    bitcredsconsensus_SCRIPT_FLAGS_VERIFY_ALL                 = bitcredsconsensus_SCRIPT_FLAGS_VERIFY_P2SH | bitcredsconsensus_SCRIPT_FLAGS_VERIFY_DERSIG |
                                                            bitcredsconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY | bitcredsconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY |
                                                            bitcredsconsensus_SCRIPT_FLAGS_VERIFY_CHECKSEQUENCEVERIFY
};
