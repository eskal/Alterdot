...
2. run alterdotd with -printalert or -sendalert like this:
   /path/to/alterdotd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.alterdot.org";
