...
2. run bitcredsd with -printalert or -sendalert like this:
   /path/to/bitcredsd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bitcreds.org";
