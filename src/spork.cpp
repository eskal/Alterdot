...
std::map<int, int64_t> mapSporkDefaults = {
    ...
    {SPORK_5_INSTANTSEND_MAX_VALUE,          1000},          // 1000 Bitcreds
    ...
    {SPORK_15_DETERMINISTIC_MNS_ENABLED,     1011640},       // Hardened to mainnet activation height (we only did this for 0.13.x) of Deterministic MNs
