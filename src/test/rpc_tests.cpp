...
{
    BOOST_CHECK_NO_THROW(CallRPC("sentinelcall 1.0.2"));
    BOOST_CHECK_THROW(CallRPC("sentinelcall"), std::runtime_error);
    BOOST_CHECK_THROW(CallRPC("sentinelcall 2"), std::bad_cast);
}
